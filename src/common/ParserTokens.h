...
PARSER_TOKEN(TOK_ACCUMULATE, "ACCUMULATE", true)
...
PARSER_TOKEN(TOK_AGGREGATE, "AGGREGATE", true)
...
PARSER_TOKEN(TOK_CUBE, "CUBE", true)
...
PARSER_TOKEN(TOK_DOWNTO, "DOWNTO", true)
...
PARSER_TOKEN(TOK_FINISH, "FINISH", true)
...
PARSER_TOKEN(TOK_GROUPING, "GROUPING", true)
PARSER_TOKEN(TOK_GROUPING_ID, "GROUPING_ID", true)
...
PARSER_TOKEN(TOK_PERCENTILE_CONT, "PERCENTILE_CONT", false)
PARSER_TOKEN(TOK_PERCENTILE_DISC, "PERCENTILE_DISC", false)
...
PARSER_TOKEN(TOK_ROLLUP, "ROLLUP", true)
...
PARSER_TOKEN(TOK_SETS, "SETS", true)
